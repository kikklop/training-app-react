...
export function TableScreen(props) {
    ...
    const loader = async ({params}) => {
        try {
            ...
            const response = await fetch(`https://devtest.teskalabs.com/data?${requestParams.toString()}`);
    ...
    const columns = [
        ...
        },
        {
            ...
            render: ({row}) => (<>
                ...
                <button onClick={() => handleDelete(row)} className="btn btn-danger"><i className="bi bi-trash"></i></button>
            </>)
        }
    ];
