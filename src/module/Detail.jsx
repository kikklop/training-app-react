            ...
            {loading ? (
                ...
                <>
                    <Card>
                        ...
                        <CardBody>
                            <p><strong>{t('user_detail|created')}:</strong> <DateTime value={user.created}/></p>
                            <p><strong>{t('user_detail|last_sign_in')}:</strong> <DateTime value={user.last_sign_in}/></p>
                            <p><strong>{t('user_detail|username')}:</strong> {user.username}</p>
                            <p><strong>{t('user_detail|email')}:</strong> {user.email}</p>
                            <p><strong>{t('user_detail|address')}:</strong> {user.address}</p>
                        </CardBody>
                    </Card>
                </>
            ) : (
